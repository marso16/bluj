...
export default function ContactForm() {
  ...
  if (status === 'sent') {
    return (
      <div className="border-l-2 border-glow pl-6">
        <p className="font-display font-black text-clean text-3xl leading-tight">Message received.</p>
        <p className="text-ghost text-sm mt-2">We'll get back to you shortly.</p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={submit} className="space-y-6">
      <div>
        <label className="text-ghost text-[11px] uppercase tracking-[0.2em] block mb-2">Name *</label>
      ...
      <div>
        <label className="text-ghost text-[11px] uppercase tracking-[0.2em] block mb-2">Message *</label>
