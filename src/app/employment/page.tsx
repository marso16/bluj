...
export default function EmploymentPage() {
  return (
    <div className="max-w-2xl mx-auto px-6 py-24">
      <p className="text-ghost text-[11px] uppercase tracking-[0.2em] mb-3">Join The Team</p>
      <h1 className="font-display font-black text-clean text-6xl md:text-7xl mb-4 leading-none">Work With Us</h1>
