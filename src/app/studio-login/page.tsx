  ...
  return (
    <div className="min-h-screen bg-ink flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <p className="font-display font-black text-glow text-5xl mb-1 leading-none">BLUJ</p>
        <p className="text-ghost text-xs uppercase tracking-[0.2em] mb-10">Studio Access</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          />
          {error && (
            <p className="text-glow text-xs uppercase tracking-widest">Wrong password</p>
          )}
          <button
            type="submit"
